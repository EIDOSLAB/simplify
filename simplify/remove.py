...
@torch.no_grad()
def remove_zeroed(model: nn.Module, x: torch.Tensor,
    ...
    def __remove_zeroed_channels_hook(module, input, output, name):
        ...
        if isinstance(module, ConvExpand):
            ...
            zeros = torch.zeros_like(module.weight).expand(module.bf.shape[0], *module.weight.shape[1:])
        ...
        # 3. If it is a pinned layer, convert it into ConvExpand or
        # BatchNormExpand
